...
const file_proto_internal_proto_rawDesc = "" +
	...
	"\x04Echo\x12\x15.internal.EchoRequest\x1a\x16.internal.EchoResponseB>Z<github.com/process-failed-successfully/horcrux/internal/grpcb\x06proto3"
...
var file_proto_internal_proto_goTypes = []any{
	(*EchoRequest)(nil),  // 0: internal.EchoRequest
	(*EchoResponse)(nil), // 1: internal.EchoResponse
}
var file_proto_internal_proto_depIdxs = []int32{
	0, // 0: internal.InternalService.Echo:input_type -> internal.EchoRequest
	1, // 1: internal.InternalService.Echo:output_type -> internal.EchoResponse
